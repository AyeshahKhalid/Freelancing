...
<head>
  ...
  <!-- web icon -->
  <link rel="shortcut icon" href="icon.png" type="image/x-icon" width="100%" height="100%">
  <!-- css style sheet -->
  <link rel="stylesheet" href="style.css">
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">


  <title>24seven Home</title>
</head>
<style>
  .modal-body {
    padding: 25px 40px;
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown">
  <button class="nav-link btn btn-secondary text-white dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="Login-Btn dropdownMenuButton">
                <?php
                // Start PHP session at the beginning 
session_start();
echo "<b> Hello ".$_SESSION["Full-name"]."!</b>";
// Create database connection using config file
include_once("data.php");
                ?>
            </button>
            
  <div class="dropdown-menu" style="background-color:gray;" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item text-dark"  href="#">Profile</a>
    <a class="dropdown-item text-dark" href="#">Project Posted</a>
    <a class="dropdown-item text-dark" href="index.php">logout</a>
  </div>
            <!-- The Modal -->
